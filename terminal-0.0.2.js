...
function handleCommand(cmd) {
  ...
  switch (cmd) {
    ...
    case "blog":
      html +=
        "" +
        '<p class="cmd-text"> rw-r--r-- 1 Tbxark staff : 2022-04-02 12:5050  <a class="file" href="https://github.com/TBXark/tbxark.github.io/blob/master/blog/2022-04-02-node-dynamicImport.md"> 在node中动态加载代码</a></p>' +
